  ...
  showProducts(products) {
    ...
    if (products) {
      if (products.length > 0) {
        ...
        // Bo di nhung san pham da xoa, khong hien thi tren giao dien nua, tuy nhien thi o database ko bi xoa
        //displayed => la ten mot column duoc Back-end dat ten
        products = products.filter(product => product.displayed) 
